...
def test_simple_test():
    ...
    control = [{"Res":"A", "Index":0, "CA":52.695,"CB":18.967,"CO":177.864,"N":126.057,"HN":8.519,"HA":4.357},
...
def test_simple_types():
    ...
    control = [{"Res":"A", "Index":0, "CA":52.673,"CB":19.015,"CO":177.793,"N":126.005,"HN":8.429,"HA":4.364},
               ...
               {"Res":"P", "Index":12, "CA":63.418,"CB":32.272,"CO":176.884,"N":"***.***","HN":"*.***","HA":4.423},
...
def test_simple_deut():
    ...
    control = [{"Res":"A", "Index":0, "CA":51.993,"CB":18.015,"CO":177.793,"N":126.005,"HN":8.429,"HA":"*.***"},
...
def test_simple_phos():
  ...
  control = [{"Res":"SEP", "Index":0, "CA":58.483,"CB":65.876,"CO":174.762,"N":119.143,"HN":9.005,"HA":4.440},
...
def test_unit_setseq():
  ...
  raw = ["KEQEERL","EGHVTPC","GQGDHQD","MHDTMII","FTWFSGH","KLD(pT)GQK","L(pY)LQATYG","QYQES(pS)RP","WWGN(pS)TGI","KHRDLAL(pY)"]

  control = [[23,23,8,3,13,3,3,14,9,23,23],[23,23,3,5,6,17,16,12,1,23,23],[23,23,5,13,5,2,6,13,2,23,23],[23,23,10,6,2,16,10,7,7,23,23],[23,23,4,16,18,4,15,5,6,23,23],[23,23,8,9,2,21,5,13,8,23,23],[23,23,9,22,9,13,0,16,19,5,23,23],[23,23,13,19,13,3,15,20,14,12,23,23],[23,23,18,18,5,11,20,16,5,7,23,23],[23,23,8,6,14,2,9,0,9,22,23,23]]
